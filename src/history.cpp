...
int HistoryMenuModel::rowCount(const QModelIndex &parent) const
{
    ...
    if (parent.internalId() /* WARN! internalId return quintptr value! */ == (quintptr) -1) { // TODO Probably this is imposible
...
QModelIndex HistoryMenuModel::mapToSource(const QModelIndex &proxyIndex) const
{
    ...
    if (proxyIndex.internalId() /* WARN! internalId return quintptr value! */ == (quintptr) -1) { // TODO Probably this is imposible
        int bumpedItems = bumpedRows();
